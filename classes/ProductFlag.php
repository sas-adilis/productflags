...
class ProductFlag extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields' => [
            ...
            'color' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
            'background_color' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
            ...
            'stop_after' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool'],
    ...
    public static function getFlags(int $id_lang, bool $active_only = true, bool $check_dates = true)
    {
        ...
        $query->innerJoin('product_flag_lang', 'l', 'p.id_product_flag = l.id_product_flag AND l.id_lang = ' . $id_lang);
        if ($check_dates) {
    ...
    public function updatePosition($way, $position, $id_product_flag = null): bool
    {
        if (!$id_product_flag) {
